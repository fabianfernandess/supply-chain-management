package com.fabian.supplychain.config;
 ...
 * Sets up the ConsumerFactory with a JsonDeserializer for our DTOs.
 */
@EnableKafka
@Configuration
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, OrderCreatedEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "shipment-group"); // Group ID for this consumer
